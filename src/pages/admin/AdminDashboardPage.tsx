    ...
    <div className="space-y-8">
      <div className="rounded-3xl bg-white p-8 shadow-lg shadow-slate-200/40">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            <span className="text-sm uppercase tracking-[0.35em] text-slate-500">Administração</span>
            <h2 className="mt-3 text-3xl font-semibold text-slate-950">Dashboard do administrador</h2>
            <p className="mt-2 text-slate-500">Visão geral do desempenho da empresa, faturamento e ranking de vendedores.</p>
          </div>
          <div className="rounded-3xl bg-slate-950 px-5 py-4 text-right text-white shadow-xl shadow-slate-800/20">
            <p className="text-sm uppercase tracking-[0.35em] text-slate-400">Acesso total</p>
            <p className="mt-3 text-2xl font-semibold">Painel administrador</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <article className="rounded-3xl bg-white p-6 shadow-lg shadow-slate-200/40">
          ...
          <p className="mt-3 text-sm text-slate-500">Transações registradas no mês</p>
        </article>
      </div>
      ...
      <section className="rounded-3xl bg-white p-6 shadow-lg shadow-slate-200/40">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h3 className="text-xl font-semibold text-slate-950">Ranking de vendedores</h3>
            <p className="mt-1 text-sm text-slate-500">Melhores desempenhos em faturamento.</p>
          </div>
          <span className="rounded-full bg-cyan-500/10 px-4 py-2 text-sm font-medium text-cyan-700">Atualizado automaticamente</span>
        </div>
